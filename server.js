...
app.post('/api/portfolio/buy', async (req, res) => {
  try {
    ...
    else { holding = new Holding({ userId, symbol, name: name || symbol, shares: quantity, avgPrice: price, exchange: exchange || 'NSE' }); await holding.save(); }
...
// ============ LIVE MARKET PRICES API (Mock - No External Dependencies) ============
